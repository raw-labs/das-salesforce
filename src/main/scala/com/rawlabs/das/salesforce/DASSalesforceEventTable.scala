  ...
  override def tableDefinition: TableDefinition = {
    ...
    val columns = Seq(
      ColumnDefinition
        .newBuilder()
        .setName("id")
        .setDescription("Activity ID of the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("who_id")
        .setDescription("Name ID (WhoId) associated with the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("what_id")
        .setDescription("Related To ID (WhatId) associated with the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("subject")
        .setDescription("The subject of the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
      ...
      ColumnDefinition
        .newBuilder()
        .setName("is_all_day_event")
        .setDescription("Indicates if the event is an all-day event (true/false).")
      ...
      ColumnDefinition
        .newBuilder()
        .setName("account_id")
        .setDescription("Account ID associated with the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("owner_id")
        .setDescription("The ID of the user to whom the event is assigned.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("is_private")
        .setDescription("Indicates if the event is private.")
        .setType(Type.newBuilder().setBool(BoolType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("show_as")
        .setDescription("Indicates how the event time should appear, such as Free, Busy, or Tentative.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
        .setName("is_deleted")
        .setDescription("Indicates if the event has been deleted.")
        .setType(Type.newBuilder().setBool(BoolType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
      ...
      ColumnDefinition
        ...
        .setDescription("ID of the user who created the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
      ...
      ColumnDefinition
        ...
        .setDescription("ID of the user who last modified the event.")
        .setType(Type.newBuilder().setString(StringType.newBuilder().setNullable(true)).build())
        .build(),
      ColumnDefinition
        .newBuilder()
